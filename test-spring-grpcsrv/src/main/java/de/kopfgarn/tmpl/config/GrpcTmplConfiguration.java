...
@Configuration
// TODO: required for spring-boot >= 3.0, remove later on
// see https://github.com/yidongnan/grpc-spring-boot-starter/pull/775#issuecomment-1329023335 for details
...
public class GrpcTmplConfiguration {
}
